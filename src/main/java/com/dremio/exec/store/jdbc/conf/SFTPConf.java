...
@SourceType(value = "SFTPARP", label = "SFTP",uiConfig = "sftp-layout.json")
public class SFTPConf extends AbstractArpConf<SFTPConf> {
  private static final String ARP_FILENAME = "arp/implementation/sftp-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.sftp.SFTPDriver";
